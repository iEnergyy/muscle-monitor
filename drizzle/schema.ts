import { mysqlTable, mysqlSchema, AnyMySqlColumn, primaryKey, int, varchar, text, index, date, tinyint, datetime, decimal, time } from "drizzle-orm/mysql-core"
...
export const muscleGroup = mysqlTable("muscle_group", {
	id: int("id").autoincrement().notNull(),
	name: varchar("name", { length: 255 }),
	description: text("description"),
},
...
export const routine = mysqlTable("routine", {
	id: int("id").autoincrement().notNull(),
...
export const routineWorkout = mysqlTable("routine_workout", {
	id: int("id").autoincrement().notNull(),
...
export const workoutExercise = mysqlTable("workout_exercise", {
	id: int("id").autoincrement().notNull(),
	workoutId: int("workout_id"),
	exerciseId: int("exercise_id"),
	sets: int("sets"),
